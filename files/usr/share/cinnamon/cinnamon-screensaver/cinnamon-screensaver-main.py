...
SCREENSAVER_DBUS_PATH = "/org/cinnamon/ScreenSaver"


# class Main(dbus.service.Object):
class Main:
    def __init__(self):
        # bus_name = dbus.service.BusName(SCREENSAVER_DBUS_NAME, bus=dbus.SessionBus())
        # dbus.service.Object.__init__(self, bus_name, SCREENSAVER_DBUS_PATH)

        self.screen_manager = ScreensaverManager()

        # self.screen_manager.setup_windows()
