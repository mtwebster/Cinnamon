...
class Backend(GObject.Object):
    ...
    def screenshot(self, include_pointer):
        return self._active().screenshot(include_pointer)

    def screenshot_window(self, include_pointer, include_shadow):
        return self._active().screenshot_window(include_pointer, include_shadow)

    def screenshot_area(self, x, y, w, h):
        return self._active().screenshot_area(x, y, w, h)

    def flash_area(self, x, y, w, h):
        self._active().flash_area(x, y, w, h)

    def select_area(self):
        return self._active().select_area()
