...
{
    CinnamonToucheggClientPrivate *priv = cinnamon_touchegg_client_get_instance_private (client);
    g_message ("CinnamonToucheggClient: connect_listener");
                ...
                gpointer      user_data)
{
    ...
    g_signal_connect (priv->connection, "closed", G_CALLBACK (connection_lost), client);
...
{
    g_message ("CinnamonToucheggClient: init_client");
...
cinnamon_touchegg_client_dispose (GObject *object)
{
    ...
    CinnamonToucheggClientPrivate *priv = cinnamon_touchegg_client_get_instance_private (client);
    g_message ("CinnamonToucheggClient dispose (%p)", object);
...
{
    g_message ("CinnamonToucheggClient finalize (%p)", object);
