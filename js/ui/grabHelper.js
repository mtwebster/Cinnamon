...
const GrabHelper = new Lang.Class({
    ...
    _takeModalGrab: function() {
        ...
        if (firstGrab) {
            if (!Main.pushModal(this._owner, global.display.get_current_time_roundtrip(), this._modalParams))
                return false;
    ...
    _releaseModalGrab: function() {
        ...
        Main.popModal(this._owner, global.display.get_current_time_roundtrip());
        global.sync_pointer();
    },
