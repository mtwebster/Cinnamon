...
const TouchpadSwipeGesture = GObject.registerClass({
    ...
    _handleEvent(actor, event) {
        ...
        if (this._allowedMode != global.stage_input_mode)
            return Clutter.EVENT_PROPAGATE;
...
const TouchSwipeGesture = GObject.registerClass({
    ...
    _init(allowedMode, nTouchPoints, thresholdTriggerEdge) {
        super._init();
...
var SwipeTracker = GObject.registerClass({
    ...
    _init(actor, allowedMode, params) {
        super._init();
        ...
        this._touchpadGesture = new TouchpadSwipeGesture(allowedMode);
        ...
        this._touchGesture = new TouchSwipeGesture(allowedMode, 4,
        ...
        if (params.allowDrag) {
            this._dragGesture = new TouchSwipeGesture(allowedMode, 1,
        ...
        if (params.allowScroll) {
            this._scrollGesture = new ScrollGesture(actor, allowedMode);
    ...
    _updateGesture(gesture, time, delta) {
        ...
        if (this._allowedMode != global.stage_input_mode || !this.enabled) {
            this._interrupt();
            return;
        }
