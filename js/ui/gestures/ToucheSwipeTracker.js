...
const { SwipeTracker } = gestures.swipeTracker;

const { toucheggClient } = gestures.touchegg.ToucheggClient;
const { GestureDirection } = gestures.touchegg.ToucheggTypes;
 ...
 */
class ToucheSwipeTrackerClass extends SwipeTracker {
  /**
   * Default constructor.
   *
  ...
  _init(actor, allowedModes, params, allowedGesture) {
    ...
    global.log('Initializing swipe support');
...
var ToucheSwipeTracker = // eslint-disable-line
  GObject.registerClass(ToucheSwipeTrackerClass);
