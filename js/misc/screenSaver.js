...
/**
 * FILE:screenSaver.js
 * @short_description: Screensaver DBus interface
 *
 * Provides a DBus proxy for the org.cinnamon.ScreenSaver interface,
 * allowing the shell to activate/deactivate the screensaver lock
 * and query its active state.
 */
